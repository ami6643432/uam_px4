...

{
	...
	while (ros::ok()){
		if(command_active_){
				...
				// points.push_back(Eigen::Vector3d(0.5, 0.0, height)); //0
				// points.push_back(Eigen::Vector3d(0.99, 0.0, height)); //0
				points.push_back(Eigen::Vector3d(1.0, 0.0, height)); //0
				// points.push_back(Eigen::Vector3d(0.5, 0.0, height)); //0
				points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0
				// points.push_back(Eigen::Vector3d(-0.5, 0.0, height)); //0
				points.push_back(Eigen::Vector3d(-1.0, 0.0, height)); //0
				...
				// points.push_back(Eigen::Vector3d(0.0, 0.91, height)); //0
				// points.push_back(Eigen::Vector3d(0.0, 0.9, height)); //0
				// points.push_back(Eigen::Vector3d(0.0, 0.89, height)); //0

				// points.push_back(Eigen::Vector3d(-0.4, 0.4, height)); //0

				// points.push_back(Eigen::Vector3d(-0.99, 0.0, height)); //0
				// points.push_back(Eigen::Vector3d(-1.0, 0.0, height)); //0
				// points.push_back(Eigen::Vector3d(-1.01, 0.0, height)); //0
...
void start_trajectory(ros::Publisher trajectory_pub, std::vector<Eigen::Vector3d> points){
	...
	ros::Rate sleep_rate(1500); //original at 100
	int i = 0;
