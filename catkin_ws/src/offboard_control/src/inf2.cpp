...

{
	...
	while (ros::ok()){
		if(command_active_){
				...
				// points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0
				// points.push_back(Eigen::Vector3d(-0.5, -0.5, height)); //1
				// points.push_back(Eigen::Vector3d(-0.9, 0.0, height)); //2
				// points.push_back(Eigen::Vector3d(-0.5, 0.5, height)); //3
				// points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0

				// // points.push_back(Eigen::Vector3d(0.5, -0.5, height)); //4
				// points.push_back(Eigen::Vector3d(0.9, 0.0, height)); //5
				// points.push_back(Eigen::Vector3d(0.5, 0.5, height)); //6
				// points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0

				// // points.push_back(Eigen::Vector3d(-0.5, -0.5, height)); //4
				// points.push_back(Eigen::Vector3d(0.0, -0.8, height)); //7
				// points.push_back(Eigen::Vector3d(0.5, -0.5, height)); //1
				// points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0
				...
				// points.push_back(Eigen::Vector3d(0.5, 0.5, height)); //6
				// points.push_back(Eigen::Vector3d(0.0, 0.8, height)); //8
				// points.push_back(Eigen::Vector3d(-0.5, 0.5, height)); //3
				// points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0

				// In y = x and y =-x axis
				points.push_back(Eigen::Vector3d(0.8, 0.8, height)); //0
				// points.push_back(Eigen::Vector3d(0.5, 0.5, height)); //0
				points.push_back(Eigen::Vector3d(0.4, 0.4, height)); //0
				points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0

				points.push_back(Eigen::Vector3d(0.05, -0.4, height)); //16
				points.push_back(Eigen::Vector3d(-0.9, -0.9, height)); //9
				points.push_back(Eigen::Vector3d(-0.4, 0.05, height)); //10

				// points.push_back(Eigen::Vector3d(-0.01, 0.0, height)); //0
				points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0
				// points.push_back(Eigen::Vector3d(0.01, 0.0, height)); //0


				points.push_back(Eigen::Vector3d(0.4, 0.05, height)); //14
				points.push_back(Eigen::Vector3d(0.9, 0.9, height)); //13
				points.push_back(Eigen::Vector3d(0.05, 0.4, height)); //12
				// points.push_back(Eigen::Vector3d(0.01, 0.0, height)); //0
				points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0
				// points.push_back(Eigen::Vector3d(0.01, 0.0, height)); //0

				points.push_back(Eigen::Vector3d(-0.05, -0.4, height)); //16
				points.push_back(Eigen::Vector3d(0.9, -0.9, height)); //15
				points.push_back(Eigen::Vector3d(0.4, 0.05, height)); //14
				points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0

				points.push_back(Eigen::Vector3d(-0.4, 0.05, height)); //10
				points.push_back(Eigen::Vector3d(-0.9, 0.9, height)); //11
				points.push_back(Eigen::Vector3d(0.05, 0.4, height)); //12
				points.push_back(Eigen::Vector3d(0.0, 0.0, height)); //0
				points.push_back(Eigen::Vector3d(0.01, 0.01 ,height)); //0
				// points.push_back(Eigen::Vector3d(0.5, 0.5, height)); //0

				points.push_back(Eigen::Vector3d(0.05, -0.4, height)); //0
				points.push_back(Eigen::Vector3d(0.9, -0.9, height)); //15
				points.push_back(Eigen::Vector3d(0.4, -0.05, height)); //15
				points.push_back(Eigen::Vector3d(0.5, 0.5, height)); //15




				start_trajectory(trajectory_pub, points);
				// ROS_INFO("Drop first payload");
				points.clear();
				break;
			}
	}
