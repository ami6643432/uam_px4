...

{
	...
	while (ros::ok()){
		if(command_active_){
				...
				points.push_back(Eigen::Vector3d(0.9, 0.0, height)); //1
				points.push_back(Eigen::Vector3d(0.673, -0.9, height)); //2
				points.push_back(Eigen::Vector3d(0.34, 0.0, height)); //3
				points.push_back(Eigen::Vector3d(0.0, 0.9, height)); //4
				points.push_back(Eigen::Vector3d(-0.34, 0.0, height)); //5
				points.push_back(Eigen::Vector3d(-0.673, -0.9, height)); //6
				points.push_back(Eigen::Vector3d(-0.9, 0.0, height)); //7

				points.push_back(Eigen::Vector3d(-0.673, 0.9, height)); //8
				points.push_back(Eigen::Vector3d(-0.34, 0.0, height)); //5
				points.push_back(Eigen::Vector3d(0.0, -0.9, height)); //9
				points.push_back(Eigen::Vector3d(0.34, 0.0, height)); //3
				points.push_back(Eigen::Vector3d(0.673, 0.9, height)); //10
				points.push_back(Eigen::Vector3d(0.9, 0.0, height)); //1
