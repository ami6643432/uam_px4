...

{
	...
	while (ros::ok()){
		if(command_active_){
				...
				points.push_back(Eigen::Vector3d(0.0, -0.5, height)); //1
				points.push_back(Eigen::Vector3d(0.0, -0.8, height)); //2
				points.push_back(Eigen::Vector3d(-0.16, -0.9, height)); //2
				points.push_back(Eigen::Vector3d(-0.28, -0.5, height)); //2
				points.push_back(Eigen::Vector3d(-0.24, -0.24, height)); //3
				points.push_back(Eigen::Vector3d(-0.5, -0.28, height)); //2
				points.push_back(Eigen::Vector3d(-0.9, -0.16, height)); //2
				...
				/*points.push_back(Eigen::Vector3d(0.0, 0.0, 2.0));
				points.push_back(Eigen::Vector3d(0.25, 0.25, 1.75));
				points.push_back(Eigen::Vector3d(0.5, 0.5, 1.5));
				points.push_back(Eigen::Vector3d(0.75, 0.75, 1.25));
				points.push_back(Eigen::Vector3d(1.0, 1.0, 1.0));
				points.push_back(Eigen::Vector3d(1.25, 1.25, 0.75));
				points.push_back(Eigen::Vector3d(1.5, 1.5, 0.5));
				points.push_back(Eigen::Vector3d(1.75, 1.75, 0.25));
				points.push_back(Eigen::Vector3d(2.0, 2.0, 0.12));*/
