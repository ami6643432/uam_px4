...

{
	...
	while (ros::ok()){
		if(command_active_){
				...
				// points.push_back(Eigen::Vector3d(0.0, 0.0, 0.7));
				// points.push_back(Eigen::Vector3d(0.2, 0.2, 0.7));
				// points.push_back(Eigen::Vector3d(0.5, 0.5, 0.7));
				// points.push_back(Eigen::Vector3d(0.7, 0.7, 0.7));
				// points.push_back(Eigen::Vector3d(0.7, 0.0, 0.7));
				// points.push_back(Eigen::Vector3d(0.5, -0.5, 0.7));
				// points.push_back(Eigen::Vector3d(0.0, -0.7, 0.7));
				// points.push_back(Eigen::Vector3d(-0.5, -0.5, 0.7));
				// points.push_back(Eigen::Vector3d(-0.7, 0.0, 0.7));
				// points.push_back(Eigen::Vector3d(-0.5, 0.5, 0.7));
				// points.push_back(Eigen::Vector3d(0.0, 0.7, 0.7));
				...
				// points.push_back(Eigen::Vector3d(0.2, 0.2, 0.7));
				// points.push_back(Eigen::Vector3d(0.0, 0.0, 0.7));
				points.push_back(Eigen::Vector3d(0.0, 0.0, height));
				points.push_back(Eigen::Vector3d(0.2, 0.2, height));
				points.push_back(Eigen::Vector3d(0.5, 0.5, height));
				points.push_back(Eigen::Vector3d(0.6, 0.35, height-0.2));
				points.push_back(Eigen::Vector3d(0.9, 0.0, height-0.15));

				points.push_back(Eigen::Vector3d(0.6, -0.35, height-0.1));
				points.push_back(Eigen::Vector3d(0.35, -0.6, height-0.05));
				// points.push_back(Eigen::Vector3d(-0.5, -0.5, 0.7));
				points.push_back(Eigen::Vector3d(-0.0, -0.8, height));

				points.push_back(Eigen::Vector3d(-0.35, -0.6, height));
				points.push_back(Eigen::Vector3d(-0.6, -0.35, height+0.05));
				points.push_back(Eigen::Vector3d(-0.9, 0.0, height+0.1));

				points.push_back(Eigen::Vector3d(-0.6, 0.35, height+0.15));
				points.push_back(Eigen::Vector3d(-0.35, 0.6, height+0.2));
				points.push_back(Eigen::Vector3d(0.0, 0.8, height));

				points.push_back(Eigen::Vector3d(0.35, 0.6, height));
				points.push_back(Eigen::Vector3d(0.6, 0.35, height));
				points.push_back(Eigen::Vector3d(0.7, 0.0, height));
				points.push_back(Eigen::Vector3d(0.0, 0.0, height));
...
void start_trajectory(ros::Publisher trajectory_pub, std::vector<Eigen::Vector3d> points){
	...
	for(i=0; i<traj_size; i++)
	{
    	...
    	ROS_INFO_STREAM(" Trajectory Message :" << traj_msg);
