...

{
	...
	while (ros::ok()){
		if(command_active_){
				...
				points.push_back(Eigen::Vector3d(0.7, 0.7, height));
				points.push_back(Eigen::Vector3d(0.3, 0.3, height));
				points.push_back(Eigen::Vector3d(0.0, 0.0, height));
				points.push_back(Eigen::Vector3d(-0.45, -0.8, height));
				points.push_back(Eigen::Vector3d(-1.0, 0.0, height));
				points.push_back(Eigen::Vector3d(-0.45, 0.8, height));
				points.push_back(Eigen::Vector3d(0.0, 0.0, height));
				points.push_back(Eigen::Vector3d(0.45, -0.8, height));
				points.push_back(Eigen::Vector3d(1.0, 0.0, height));
				...
				points.push_back(Eigen::Vector3d(-0.45, 0.45, height));
				points.push_back(Eigen::Vector3d(0.0, 0.8, height));
				points.push_back(Eigen::Vector3d(0.45, 0.45, height));
				points.push_back(Eigen::Vector3d(0.0, 0.0, height));
				points.push_back(Eigen::Vector3d(-0.3, -0.1, height));
				points.push_back(Eigen::Vector3d(-0.6, -0.2, height));


				// points.push_back(Eigen::Vector3d(0.0, 0.0, 0.6));
				// points.push_back(Eigen::Vector3d(0.8, -0.5, 0.5));
				// points.push_back(Eigen::Vector3d(0.8, -0.8, 0.4));
				// points.push_back(Eigen::Vector3d(0.5, -0.8, 0.5));
				// points.push_back(Eigen::Vector3d(0.0, 0.0, 0.6));
				// points.push_back(Eigen::Vector3d(-0.5, 0.8, 0.5));
				// points.push_back(Eigen::Vector3d(-0.8, 0.8, 0.4));
				// points.push_back(Eigen::Vector3d(-0.8, 0.5, 0.5));
