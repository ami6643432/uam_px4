...

{
	...
	while (ros::ok()){
		if(command_active_){
				...
				points.push_back(Eigen::Vector3d(0.5, 0.0, 0.7));
				points.push_back(Eigen::Vector3d(0.65, 0.0 ,0.7));
				points.push_back(Eigen::Vector3d(0.4, -0.65, 0.7));
				// points.push_back(Eigen::Vector3d(0.25, -0.3, 2.01));
				points.push_back(Eigen::Vector3d(0.0, -0.8, 0.7));
				points.push_back(Eigen::Vector3d(0.0, -0.5, 0.7));
				points.push_back(Eigen::Vector3d(0.0, -0.25, 0.7));

				points.push_back(Eigen::Vector3d(0, 0, 0.7));
				points.push_back(Eigen::Vector3d(0.0, 0.25, 0.7));
				points.push_back(Eigen::Vector3d(0.0, 0.5, 0.7));
				points.push_back(Eigen::Vector3d(0.0, 0.6, 0.7));
				points.push_back(Eigen::Vector3d(0.0, 0.75, 0.7));
				// points.push_back(Eigen::Vector3d(-0.25, 0.3, 2.01));
				points.push_back(Eigen::Vector3d(0.0, 0.8, 0.7));
				points.push_back(Eigen::Vector3d(-0.4, 0.7, 0.7));
				points.push_back(Eigen::Vector3d(-0.8, 0.0, 0.7));
				// points.push_back(Eigen::Vector3d(-0.5, 0.0, 2.01));
				// points.push_back(Eigen::Vector3d(0.0, 0.0, 2.01));
...
void start_trajectory(ros::Publisher trajectory_pub, std::vector<Eigen::Vector3d> points){
	...
	ros::Rate sleep_rate(300); //original at 100
	int i = 0;
