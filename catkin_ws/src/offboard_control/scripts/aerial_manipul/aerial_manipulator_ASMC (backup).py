...
class Controller:
    ...
    def __init__(self):
        ...
        # self.desPos_m1, self.desPos_m2 = 65, -55   #conf1 start flying with this
    ...
    def multiDoFCb(self, msg):
        ...
        # if (pt.transforms[0].translation.x < 0.31 and pt.transforms[0].translation.x > 0.39) \
        # and (pt.transforms[0].translation.y > -0.01 and pt.transforms[0].translation.y < 0.01 ):         
        #     GPIO.output(self.pin_1, True)
        #     print("Takeoff at",pt.transforms[0].translation.x)
        #     # Gripper Code Config 1 takeoff
        ...
        and (pt.transforms[0].translation.y > -0.01 and pt.transforms[0].translation.y < 0.01 ):
            ...
            self.desPos_m1, self.desPos_m2 = -45, 0
