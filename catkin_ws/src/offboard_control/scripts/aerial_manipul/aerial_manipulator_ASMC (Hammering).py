...
class Controller:
    ...
    def __init__(self):
        ...
        #Drone
        self.Kp0 = np.array([1.0, 1.0, 1.0])
        self.Kp1 = np.array([1.0, 1.0, 1.0])
        self.alpha_0 = np.array([1,1,1])
        self.alpha_1 = np.array([1,1,1])
        self.alpha_m = 0.015 #Change 3

        self.Lam = np.array([1.5, 1.5, 4.5]) #Change 1
        self.Phi = np.array([1.5, 1.5, 1.75])
        self.M = 0.075 #Change 2
        self.v = 0.1  
    ...
    def armUpDown(self):
        ...
        time.sleep(0.5)
        self.desPos_m1, self.desPos_m2 = -40, 40
        time.sleep(0.5)
