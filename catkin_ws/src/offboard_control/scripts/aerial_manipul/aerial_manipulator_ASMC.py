...
class Controller:
    ...
    def __init__(self):
        ...
        # self.Kp1 = np.array([1.0, 2.0, 1.0])
        # self.alpha_0 = np.array([1,1,1])
        # self.alpha_1 = np.array([1,1,1])
        # self.alpha_m = 0.05 #Change 3

        # self.Lam = np.array([1.5, 1.5, 3.0]) #Change 1
        # self.Phi = np.array([1.2, 1.5, 1.0])
        # self.M = 0.05 #Change 2
        # self.v = 0.1  

        #Drone
        self.Kp0 = np.array([0.1, 0.1, 0.1])
        self.Kp1 = np.array([0.1, 0.1, 0.1])
        self.alpha_0 = np.array([1.0,1.0,1.1])
        self.alpha_1 = np.array([1.0,1.0,1.1])
        self.v = 0.1  
        # self.alpha_m = 0.01 #Change 3
        # self.Lam = np.array([1.5, 1.5, 4.0]) #Change 1
        # self.Phi = np.array([1.5, 1.5, 1.5])
        # self.M = 0.10 #Change 2
        self.alpha_m = 0.001

        self.Lam = np.array([1.5, 1.5, 3.2]) 
        self.Phi = np.array([1.2, 1.2, 1.0])
        ...
        self.arm_flag = 1
        # self.desPos_m1, self.desPos_m2 = 0, 0
        # self.desPos_m1, self.desPos_m2 = 55, -55   #conf1 start flying with this (old)
        # self.desPos_m1, self.desPos_m2 = -60,60   #conf1 start flying with this

        # self.desPos_m1, self.desPos_m2 = -65, 55   #conf2
        # self.desPos_m1, self.desPos_m2 = -75, 75   #conf3 High
        # self.desPos_m1, self.desPos_m2 = -55, 55   #conf4 Low
    ...
    def multiDoFCb(self, msg):
        ...
        # # print(pt.transforms[0].translation.x)
        # # if (pt.transforms[0].translation.x < 0.41 and pt.transforms[0].translation.x > 0.39) \
        # # and (pt.transforms[0].translation.y > -0.01 and pt.transforms[0].translation.y < 0.01 ):
        # #     # print("Change Config : ",pt.transforms[0].translation.x)
        # #     # GPIO.output(self.pin_1, False)
        # #     # print("EM ON")
        # #     # Gripper Code Config 2
        # #     self.desPos_m1, self.desPos_m2 = 55, -55 


        # # if (pt.transforms[0].translation.x < 0.21 and pt.transforms[0].translation.x > 0.19) \
        # # and (pt.transforms[0].translation.y > -0.01 and pt.transforms[0].translation.y < 0.01 ):
        # #     # print("Change Config : ",pt.transforms[0].translation.x)
        # #     # GPIO.output(self.pin_1, False)
        # #     # print("EM ON")
        # #     # Gripper Code Config 2
        # #     self.desPos_m1, self.desPos_m2 = -65,65
        # #     print("conf2")
        ...
        # #     # print("EM ON")
        # #     # Gripper Code Config 2
        # #     self.desPos_m1, self.desPos_m2 = -45, 45
        # #     # print("conf2")
        ...
        # #     # print("EM ON")
        # #     # Gripper Code Config 2
        # #     self.desPos_m1, self.desPos_m2 = -50, 50
        # #     # print("conf2")
        ...
        # if (pt.transforms[0].translation.x < .11 and pt.transforms[0].translation.x > 0.09) \
        # and (pt.transforms[0].translation.y > -0.01 and pt.transforms[0].translation.y < 0.01 ):
        #     print("At 0.1")
        #     # print("Change Config : ",pt.transforms[0].translation.x)
        #     # GPIO.output(self.pin_1, False)
    ...
    def th_des(self):
        ...
        if self.armed:
            ...
            self.Kp1 += (np.multiply(sv, self.Kp1) - np.multiply(self.alpha_1, self.Kp1))*dt
            # print(sv)
            # print(self.Kp1)
            # print(np.multiply(sv, self.Kp1))
            # print("-------------------")
...
def main(argv):
    ...
    # dynamixel_obj1.set_goal_pos_callback(175) #motor 1 first
    # dynamixel_obj2.set_goal_pos_callback(359) #gripper actuator motor
    # dynamixel_obj3.set_goal_pos_callback(300) #link 2 motor
