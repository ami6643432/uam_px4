...
def main(argv):
    ...
    obj0.set_goal_pos_callback(200) #motor 1 first
    obj1.set_goal_pos_callback(80) #link 2 motor

    # obj2.set_goal_pos_callback(70) #
    # obj3.set_goal_pos_callback(140) #link 3
