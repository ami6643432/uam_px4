...
class Controller:
    ...
    def __init__(self):
        ...
        self.Lam = np.array([2.2, 2.2, 4.5]) #Change 1    #[1.75, 1.75, 4]
    ...
    def multiDoFCb(self, msg):
        ...
        and (pt.transforms[0].translation.y > -0.01 and pt.transforms[0].translation.y < 0.01 ):
            ...
            # dynamixel_obj0.set_goal_pos_callback(130) #motor 1 first
            # dynamixel_obj2.set_goal_pos_callback(140) #link 2 motor
            dynamixel_obj3.set_goal_pos_callback(220) #gripper
        ...
        # ( 0, 0.20)(Lock Position if there are only two objects)
        if (pt.transforms[0].translation.x < 0.01  and pt.transforms[0].translation.x > -0.01) \
        and (pt.transforms[0].translation.y > 0.19 and pt.transforms[0].translation.y < 0.21 ):
            print("End. ( 0, 0.20) Landing Position Reached")
            dynamixel_obj0.set_goal_pos_callback(180) #motor 1 first
            dynamixel_obj2.set_goal_pos_callback(90) #link 2 motor
            dynamixel_obj3.set_goal_pos_callback(180) #gripper
