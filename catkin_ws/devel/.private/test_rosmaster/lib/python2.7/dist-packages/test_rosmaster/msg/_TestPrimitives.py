...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_bhiqBHIQfd2I2i().pack(_x.b, _x.int16, _x.int32, _x.int64, _x.c, _x.uint16, _x.uint32, _x.uint64, _x.float32, _x.float64, _x.t.secs, _x.t.nsecs, _x.d.secs, _x.d.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.b, _x.int16, _x.int32, _x.int64, _x.c, _x.uint16, _x.uint32, _x.uint64, _x.float32, _x.float64, _x.t.secs, _x.t.nsecs, _x.d.secs, _x.d.nsecs,) = _get_struct_bhiqBHIQfd2I2i().unpack(str[start:end])
      self.t.canon()
      self.d.canon()
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_bhiqBHIQfd2I2i = None
def _get_struct_bhiqBHIQfd2I2i():
    global _struct_bhiqBHIQfd2I2i
    if _struct_bhiqBHIQfd2I2i is None:
        _struct_bhiqBHIQfd2I2i = struct.Struct("<bhiqBHIQfd2I2i")
    return _struct_bhiqBHIQfd2I2i
