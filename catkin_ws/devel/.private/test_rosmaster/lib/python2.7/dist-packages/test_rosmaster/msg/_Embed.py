...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_bhiqBHIQ().pack(_x.simple.b, _x.simple.int16, _x.simple.int32, _x.simple.int64, _x.simple.c, _x.simple.uint16, _x.simple.uint32, _x.simple.uint64))
      _x = self.simple.str
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.simple.b, _x.simple.int16, _x.simple.int32, _x.simple.int64, _x.simple.c, _x.simple.uint16, _x.simple.uint32, _x.simple.uint64,) = _get_struct_bhiqBHIQ().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_2I():
    ...
    return _struct_2I
_struct_bhiqBHIQ = None
def _get_struct_bhiqBHIQ():
    global _struct_bhiqBHIQ
    if _struct_bhiqBHIQ is None:
        _struct_bhiqBHIQ = struct.Struct("<bhiqBHIQ")
    return _struct_bhiqBHIQ
