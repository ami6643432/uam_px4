...
class SubUnmigrated(genpy.Message):
  _md5sum = "4aa26f1425c68e8cf54c7adae649c1d9"
...
float64 field4 #123.4"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_fd().pack(_x.field2.field3, _x.field2.field4))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.field2.field3, _x.field2.field4,) = _get_struct_fd().unpack(str[start:end])
      return self
