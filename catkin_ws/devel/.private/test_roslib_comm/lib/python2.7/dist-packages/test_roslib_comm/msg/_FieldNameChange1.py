...
float64[] e"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_if().pack(_x.a.a, _x.a.b))
      _x = self.a.c
      length = len(_x)
      ...
      buff.write(_get_struct_10Q().pack(*self.a.d))
      length = len(self.a.e)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.a.a, _x.a.b,) = _get_struct_if().unpack(str[start:end])
      start = end
      end += 4
      ...
      self.a.d = _get_struct_10Q().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
