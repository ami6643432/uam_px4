...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_bhiqBHIQ().pack(_x.b, _x.int16, _x.int32, _x.int64, _x.c, _x.uint16, _x.uint32, _x.uint64))
      _x = self.str
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.b, _x.int16, _x.int32, _x.int64, _x.c, _x.uint16, _x.uint32, _x.uint64,) = _get_struct_bhiqBHIQ().unpack(str[start:end])
      start = end
      end += 4
