...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2dQI().pack(_x.publish_time, _x.receipt_time, _x.count, _x.thread_index))
      _x = self.array
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.publish_time, _x.receipt_time, _x.count, _x.thread_index,) = _get_struct_2dQI().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2dQI = None
def _get_struct_2dQI():
    global _struct_2dQI
    if _struct_2dQI is None:
