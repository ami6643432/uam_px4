		...
		if(command_active_)
		    {
				...
				points.push_back(Eigen::Vector3d(0.0, 0, height));


				// points.push_back(Eigen::Vector3d(-0.25, 0, height));

				// Grab position (Approach position)
				points.push_back(Eigen::Vector3d(-0.5, 0, height));


				points.push_back(Eigen::Vector3d(-0.6, 0, height));
				
				// Grab position (Gripper close) 
				points.push_back(Eigen::Vector3d(-0.7, 0, height));

				// 
				points.push_back(Eigen::Vector3d(-0.6, .10, height));

				// Drop position -> Grab position (Gripper open)
				points.push_back(Eigen::Vector3d(-0.5, .20, height));


				// points.push_back(Eigen::Vector3d(-0.25, .20, height));

				// Land position
				points.push_back(Eigen::Vector3d( 0.0, .20, height));

				// // Object 2

				// // Grab position (Gripper close)
				// points.push_back(Eigen::Vector3d(-0.7, .20, height));

				// // 
				// points.push_back(Eigen::Vector3d(-0.6, .30, height));

				// // Drop position -> Grab position (Gripper open)
				// points.push_back(Eigen::Vector3d(-0.5, .40, height));

				// // Land
				// points.push_back(Eigen::Vector3d( 0.0, .40, height));


				// // Object 3	

				// // Grab position (Gripper close)
				// points.push_back(Eigen::Vector3d(-0.7, .40, height));

				// // 
				// points.push_back(Eigen::Vector3d(-0.6, .50, height));

				// // Drop position -> lock
				// points.push_back(Eigen::Vector3d(-0.5, .60, height));

				// // Land
				// points.push_back(Eigen::Vector3d( 0.0, .60, height));
