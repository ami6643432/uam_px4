		...
		if(command_active_)
		    {
				...
				points.push_back(Eigen::Vector3d(0.0, 0, height));
				points.push_back(Eigen::Vector3d(-0.3, 0, height));
				points.push_back(Eigen::Vector3d(0., 0, height));
				points.push_back(Eigen::Vector3d(0.4, 0, height));

				points.push_back(Eigen::Vector3d(0.6, -0.1, height));
				points.push_back(Eigen::Vector3d(0.3, -0.1, height));
				points.push_back(Eigen::Vector3d(0.0, -0.1, height));
				points.push_back(Eigen::Vector3d(-0.3, -0.1, height));
				points.push_back(Eigen::Vector3d(-0.55, -0.1, height));
				points.push_back(Eigen::Vector3d(-0.6, -0.1, height));
				points.push_back(Eigen::Vector3d(-0.55, -0.1, height));

				points.push_back(Eigen::Vector3d(-0.45, -0.05, height));

				points.push_back(Eigen::Vector3d(-0.3, 0.0, height));

				// points.push_back(Eigen::Vector3d(0.0, 0, height));
				

				// points.push_back(Eigen::Vector3d(-0.35, 0, height));
