...

{
	...
	while (ros::ok()){
		if(command_active_){
				...
				points.push_back(Eigen::Vector3d(0.7, 0, 0.6));
				points.push_back(Eigen::Vector3d(0.2, 0, 0.6));
				points.push_back(Eigen::Vector3d(0.0, 0, 0.7));
				points.push_back(Eigen::Vector3d(-0.3, 0, 0.8));
				points.push_back(Eigen::Vector3d(-0.6, 0, 0.9));
				points.push_back(Eigen::Vector3d(-0.8, 0, 1));
